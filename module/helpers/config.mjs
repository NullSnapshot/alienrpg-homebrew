...
ALIENRPG.conditionEffects = [
	{
		...
		icon: "systems/alienrpg-homebrew/images/starving.webp",
	},
	{
		id: "dehydrated",
		name: "ALIENRPG.Dehydrated",
		label: "ALIENRPG.Dehydrated",
		icon: "systems/alienrpg-homebrew/images/water-flask.webp",
	},
	{
		id: "exhausted",
		name: "ALIENRPG.Exhausted",
		label: "ALIENRPG.Exhausted",
		icon: "systems/alienrpg-homebrew/images/exhausted.webp",
	},
	{
		id: "freezing",
		name: "ALIENRPG.Freezing",
		label: "ALIENRPG.Freezing",
		icon: "systems/alienrpg-homebrew/images/freezing.webp",
	},
	{
		id: "encumbered",
		name: "ALIENRPG.Encumbered",
		label: "ALIENRPG.Encumbered",
		icon: "systems/alienrpg-homebrew/images/weight.webp",
	},
	{
		id: "panicked",
		name: "ALIENRPG.Panicked",
		label: "ALIENRPG.Panicked",
		icon: "systems/alienrpg-homebrew/images/panic.webp",
	},
	{
		id: "overwatch",
		name: "ALIENRPG.Overwatch",
		label: "ALIENRPG.Overwatch",
		icon: "systems/alienrpg-homebrew/images/overwatch.webp",
	},
	{
		id: "radiation",
		name: "ALIENRPG.Radiation",
		label: "ALIENRPG.Radiation",
		icon: "systems/alienrpg-homebrew/images/radiation.webp",
	},
	{
		id: "hypoxia",
		name: "ALIENRPG.hypoxia",
		label: "ALIENRPG.hypoxia",
		icon: "systems/alienrpg-homebrew/images/hypoxia.webp",
	},
	{
		id: "heatstroke",
		name: "ALIENRPG.heatstroke",
		label: "ALIENRPG.heatstroke",
		icon: "systems/alienrpg-homebrew/images/heatstroke.webp",
	},
	{
		id: "gravitydyspraxia",
		name: "ALIENRPG.gravitydyspraxia",
		label: "ALIENRPG.gravitydyspraxia",
		icon: "systems/alienrpg-homebrew/images/gravitydyspraxia.webp",
	},
	{
		id: "criticalinj",
	...
	},
	{
		...
		icon: "systems/alienrpg-homebrew/images/lightning-spanner.webp",
	},
	{
		id: "shipmajor",
		name: "ALIENRPG.MAJOR-COMPONENT-DAMAGE",
		label: "ALIENRPG.MAJOR-COMPONENT-DAMAGE",
		icon: "systems/alienrpg-homebrew/images/cogsplosion.webp",
	},
]
...
ALIENRPG.conditions = {
	jumpy: {
		...
		resp: "stress",
		tableNumber: 1,
		img: "systems/alienrpg-homebrew/images/icons/jumpy.webp",
	...
	tunnelvision: {
		...
		resp: "stress",
		tableNumber: 2,
		img: "systems/alienrpg-homebrew/images/icons/tunnelvision.webp",
		changes: [
	...
	aggravated: {
		...
		resp: "stress",
		tableNumber: 3,
		img: "systems/alienrpg-homebrew/images/icons/aggravated.webp",
		changes: [
	...
	shakes: {
		...
		resp: "stress",
		tableNumber: 4,
		img: "systems/alienrpg-homebrew/images/icons/shakes.webp",
		changes: [
	...
	frantic: {
		...
		resp: "stress",
		tableNumber: 5,
		img: "systems/alienrpg-homebrew/images/icons/frantic.webp",
		changes: [
	...
	deflated: {
		...
		resp: "stress",
		tableNumber: 6,
		img: "systems/alienrpg-homebrew/images/icons/deflated.webp",
	},
	messup: {
		name: "ALIENRPG.messup",
		resp: "stress",
		tableNumber: 7,
		img: "systems/alienrpg-homebrew/images/icons/messup.webp",
	},
	fatigued: {
		name: "ALIENRPG.fatigued",
		resp: "",
		tableNumber: 0,
		img: "systems/alienrpg-homebrew/images/icons/fatigued.webp",
	},
	keepingguard: {
		name: "ALIENRPG.keepingguard",
		resp: "stress",
		tableNumber: 0,
		img: "systems/alienrpg-homebrew/images/overwatch.webp",
	...
	spooked: {
		...
		img: "systems/alienrpg-homebrew/images/icons/spooked.webp",
	},
	noisy: {
		name: "ALIENRPG.noisy",
		resp: "panic",
		tableNumber: 2,
		img: "systems/alienrpg-homebrew/images/icons/noisy.webp",
	},
	twitchy: {
		name: "ALIENRPG.twitchy",
		resp: "panic",
		tableNumber: 3,
		img: "systems/alienrpg-homebrew/images/icons/twitchy.webp",
	},
	loseitem: {
		name: "ALIENRPG.loseitem",
		resp: "panic",
		tableNumber: 4,
		img: "systems/alienrpg-homebrew/images/icons/lose-item.webp",
	},
	paranoid: {
		name: "ALIENRPG.paranoid",
		resp: "panic",
		tableNumber: 5,
		img: "systems/alienrpg-homebrew/images/icons/paranoid.webp",
	},
	hesitant: {
		name: "ALIENRPG.hesitant",
		resp: "panic",
		tableNumber: 6,
		img: "systems/alienrpg-homebrew/images/icons/hesitant.webp",
	},
	freeze: {
		name: "ALIENRPG.freeze",
		resp: "panic",
		tableNumber: 7,
		img: "systems/alienrpg-homebrew/images/icons/freeze.webp",
	},
	seekcover: {
		name: "ALIENRPG.seekcover",
		resp: "panic",
		tableNumber: 8,
		img: "systems/alienrpg-homebrew/images/icons/seekcover.webp",
	},
	scream: {
		name: "ALIENRPG.scream",
		resp: "panic",
		tableNumber: 9,
		img: "systems/alienrpg-homebrew/images/icons/scream.webp",
	},
	flee: {
		name: "ALIENRPG.flee",
		resp: "panic",
		tableNumber: 10,
		img: "systems/alienrpg-homebrew/images/icons/flee.webp",
	},
	frenzy: {
		name: "ALIENRPG.frenzy",
		resp: "panic",
		tableNumber: 11,
		img: "systems/alienrpg-homebrew/images/icons/frenzy.webp",
	},
	catatonic: {
		name: "ALIENRPG.catatonic",
		resp: "panic",
		tableNumber: 12,
		img: "systems/alienrpg-homebrew/images/icons/catatonic.webp",
	},
}
	...
	slowAndFastActions: [
		{
			...
			icon: "systems/alienrpg-homebrew/images/icons/fast-action.webp",
			statuses: ["fastAction"],
		},
		{
			...
			icon: "systems/alienrpg-homebrew/images/icons/slow-action.webp",
			statuses: ["slowAction"],
		},
	],
}
